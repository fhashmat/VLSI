...
This folder contains software supply-chain attack-vector extraction sheets used to build the `A_sw -> M` side of the VLSI-SWSC taxonomy.

Here, `A_sw` means the software supply-chain attack vector, and `M` means the mechanism or attacker capability enabled by that vector.
